...
```toml
[dependencies]
clamav-client = { version = "2.3.0", features = ["tokio"] }
```
...
```toml
[dependencies]
clamav-client = { version = "2.3.0", features = ["tokio-stream"] }
```
...
```toml
[dependencies]
clamav-client = { version = "2.3.0", features = ["smol"] }
```
...
```toml
[dependencies]
clamav-client = { version = "2.3.0", features = ["async-std"] }
```
